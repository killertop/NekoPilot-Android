...
object Key {
    ...
    const val APP_PROXY_DESIRED_REVISION = "appProxyDesiredRevision"
    const val APP_PROXY_APPLIED_REVISION = "appProxyAppliedRevision"
    const val APP_PROXY_APPLIED_ENABLED = "appProxyAppliedEnabled"
    const val APP_PROXY_APPLIED_PACKAGES = "appProxyAppliedPackages"
    const val APP_PROXY_APPLIED_TUN_GENERATION = "appProxyAppliedTunGeneration"
    const val APP_PROXY_TUN_GENERATION_COUNTER = "appProxyTunGenerationCounter"
    const val APP_PROXY_ATTEMPT_REVISION = "appProxyAttemptRevision"
    const val APP_PROXY_ATTEMPT_TOKEN = "appProxyAttemptToken"
    const val APP_PROXY_ATTEMPT_TUN_GENERATION = "appProxyAttemptTunGeneration"
    const val APP_PROXY_APPLY_STATUS = "appProxyApplyStatus"
    const val APP_PROXY_APPLY_FAILURE = "appProxyApplyFailure"
    const val SHOW_NODE_IP = "showNodeIp"
    const val SHOW_SERVER_LOCATION = "showServerLocation"
