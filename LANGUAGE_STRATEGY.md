...
Current physical production source size is approximately 20.8k Kotlin, 2.4k Java, and 8.5k Go lines. The former generated `SingBoxOptions.java` graph was removed after the Go config compiler made it unreachable. There is no Rust source.
